...
from handlers.keyboards import (
    get_gender_selection_keyboard, get_bot_gender_selection_keyboard,
    get_communication_style_keyboard, get_settings_keyboard, get_back_keyboard
)
...
@router.callback_query(SettingsStates.waiting_for_bot_gender, F.data.startswith("bot_gender_"))
